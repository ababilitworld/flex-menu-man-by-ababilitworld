<?php
namespace Ababilitworld\FlexMenuManByAbabilitworld;
...
defined( __NAMESPACE__.'\PLUGIN_PRE_UNDS' ) || define( __NAMESPACE__.'\PLUGIN_PRE_UNDS', 'flex_color_scheme_by_ababilitworld' );
defined( __NAMESPACE__.'\PLUGIN_PRE_HYPH' ) || define( __NAMESPACE__.'\PLUGIN_PRE_HYPH', 'flex-color-scheme-by-ababilitworld' );
